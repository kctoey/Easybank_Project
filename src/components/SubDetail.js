...
const SubDetial = () => {
  ...
  return (
    <div className="flex flex-col justify-center text-center pb-20 space-y-8  lg:flex lg:flex-row lg:w-full lg:space-x-48 font-Quicksand ">
      <div data-aos="zoom-in" data-aos-duration="1000">
        <img className="mx-auto lg:mx-0 mt-8" src={online} alt="" />
        <h1 className="py-4 mt-2  font-bold text-slate-600 text-lg">
          Online Banking
        </h1>
        <p className="font-bold text-slate-400 text-base leading-relaxed px-8">
